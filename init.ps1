...
Add-HostsEntry "cm.jss_1.localhost"
Add-HostsEntry "cd.jss_1.localhost"
Add-HostsEntry "id.jss_1.localhost"
Add-HostsEntry "www.jss_1.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.jss_1.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.jss_1.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.jss_1.localhost"
